...
def mine_block():
    ...
    # Call add_transaction method to add transactions to transactions list
...
def add_transaction():
    ...
    # Check all keys are in json file or return an error
    if not all(key in json for key in transaction_keys):
        return 'Some elements of the transaction are missing', 400
    # If no error returned we add transaction to next mined block
